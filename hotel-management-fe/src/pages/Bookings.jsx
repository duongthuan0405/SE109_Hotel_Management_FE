...
export default function Bookings() {
  ...
  const getRoomTypeName = (hangPhongId) => {
  const roomType = roomTypes.find((type) => type._id === hangPhongId);
  return roomType ? roomType.TenLoaiPhong : hangPhongId || "N/A";
  };
              ...
              <TableBody>
                {filteredBookings.map((booking) => (
                  <TableRow key={booking._id}>
                    ...
                    <TableCell>{getRoomTypeName(booking.HangPhong)}</TableCell>
                    <TableCell>
                      {booking.NgayDen
